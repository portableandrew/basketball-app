...
const WORKOUT_DETAILS: Record<string, WorkoutDetail> = {
  ...
  perimeter_6: {
    ...
    category: "perimeter",
    goal: "Reach the highest level possible in 30 minutes by making only clean swishes under pressure",
    skillFocus: "Touch, focus, handle-to-shot rhythm, and mental composure",
    estimatedTime: 30,
    equipment: ["Basketball", "Hoop", "Optional timer"],
    steps: [
      {
        stepNumber: 1,
        title: "Level 1 - Under Rim",
        description: "Directly under the rim, make 5 swishes in a row. Any non-swish resets the count.",
        sets: 1,
        reps: 5,
      },
      {
        stepNumber: 2,
        title: "Level 2 - Middle Paint",
        description: "From the middle of the paint, make 5 swishes in a row.",
        sets: 1,
        reps: 5,
      },
      {
        stepNumber: 3,
        title: "Level 3 - Free Throw Line",
        description: "From the free throw line, make 5 swishes in a row.",
        sets: 1,
        reps: 5,
      },
      {
        stepNumber: 4,
        title: "Level 4 - FT Line Drop + Switch Back",
        description: "Start at free throw line. Drop dribble, switch back, then shoot. Make 2 swishes in a row.",
        sets: 1,
        reps: 2,
      },
      {
        stepNumber: 5,
        title: "Level 5 - 3PT Line Into Middy Pull-Up",
        description: "Start at the 3-point line. Drop through the legs, take 2 steps in, pull up in the midrange. Make 2 swishes in a row.",
        sets: 1,
        reps: 2,
      },
      {
        stepNumber: 6,
        title: "Level 6 - 3PT Line To Elbow Pull-Up",
        description: "Start at the 3-point line. Drop through the legs, take 2 steps to the elbow, shoot. Make 2 swishes in a row.",
        sets: 1,
        reps: 2,
      },
      {
        stepNumber: 7,
        title: "Level 7 - FT Line Facing Corner Of Key",
        description: "From free throw line facing the corner of the key, drop through and take 2 steps, then shoot. Make 2 swishes in a row.",
        sets: 1,
        reps: 2,
      },
      {
        stepNumber: 8,
        title: "Level 8 - Top Of Key 3",
        description: "From top of key behind the arc, make 3 swishes in a row.",
        sets: 1,
        reps: 3,
      },
      {
        stepNumber: 9,
        title: "Level 9 - Top Of Key 3 With Drop Reset",
        description: "At top of key 3, drop and reset before each shot, alternating side each rep. Make 2 swishes in a row.",
        sets: 1,
        reps: 2,
      },
      {
        stepNumber: 10,
        title: "Level 10 - Outside Top Of Key Off 2 Steps",
        description: "Drop through the legs, take 2 steps, and shoot outside the top of key. Make 2 swishes in a row.",
        sets: 1,
        reps: 2,
      },
    ],
    coachingCues: [
      "Only count true swishes; treat rim makes as misses for this challenge.",
      "Stay calm after misses. Reset quickly and keep your mechanics identical.",
      "Keep footwork clean before every pull-up from dribble moves.",
      "Use game pace, but never rush your release into poor form.",
      "Track highest level reached each session to measure progress.",
    ],
    commonMistakes: [
      "Speeding up after one make and losing rhythm on the next shot.",
      "Changing mechanics between stationary levels and off-dribble levels.",
      "Forgetting to reset count after a non-swish make.",
    ],
    loggingInstructions:
      "In Log Workout Step 3, enter your Swish Everything score as the highest level reached (0-10).",
  },
  // Finishing Craft
  finishing_1: {
    id: "finishing_1",
